...
public:
    ...
    void setupUi(QWidget *RoomListUi)
    {
        ...
        widget->setGeometry(QRect(310, 122, 183, 347));
        gridLayout = new QGridLayout(widget);
        gridLayout->setObjectName(QStringLiteral("gridLayout"));
        gridLayout->setContentsMargins(0, 0, 0, 0);
        btn_creatRoom = new QPushButton(widget);
        ...
        btn_chargeMoney = new QPushButton(widget);
        ...
        le_namePer = new QLineEdit(widget);
        ...
        le_moneyPer = new QLineEdit(widget);
        ...
        le_leverPer = new QLineEdit(widget);
        le_leverPer->setObjectName(QStringLiteral("le_leverPer"));

        gridLayout->addWidget(le_leverPer, 8, 2, 1, 1);

        widget1 = new QWidget(RoomListUi);
        widget1->setObjectName(QStringLiteral("widget1"));
        widget1->setGeometry(QRect(40, 50, 251, 25));
        ...
        btn_refresh = new QPushButton(widget1);
        btn_refresh->setObjectName(QStringLiteral("btn_refresh"));

        gridLayout_2->addWidget(btn_refresh, 0, 1, 1, 1);

        widget2 = new QWidget(RoomListUi);
        widget2->setObjectName(QStringLiteral("widget2"));
        widget2->setGeometry(QRect(30, 490, 271, 25));
    ...
    void retranslateUi(QWidget *RoomListUi)
    {
        ...
        pushButton->setText(QApplication::translate("RoomListUi", "\344\270\213\347\272\277", Q_NULLPTR));
        pushButton_2->setText(QApplication::translate("RoomListUi", "\346\263\250\351\224\200", Q_NULLPTR));
    } // retranslateUi
